...
public class DebugConsole : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (draggable == true)
        {
            ...
            {
                GUIText guiText = DebugGui.GetComponent<GUIText>();
                if (connectedToMouse == false && guiText.HitTest((Vector3)Input.mousePosition) == true)
                {
    ...
    void ClearScreen()
    {
        ...
        else
        {
            ...
            while (x < guis.Count)
            {
                ...
                GUIText guiText = gui.GetComponent<GUIText>();
                guiText.text = "";
                //increment and loop
                x += 1;
            }
        ...
        else if (visible == true)
        {
            ...
            else
            {
                while (x < messages.Count)
                {
                    ...
                    guiText.text = (string)messages[x];
